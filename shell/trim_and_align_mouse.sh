...
~/BisPin/shell/align_mouse.sh $2.reaper.lane.clean $2.reaper.out $3

/home/jsporter/sickle/sickle se -f $1 -t sanger -o $2.sickle.fastq

~/BisPin/shell/align_mouse.sh $2.sickle.fastq $2.sickle.out $3

~/BisPin/InfoTrim.py -p $3  $1  1> $2.infotrim.fastq 2> $2.infotrim.info 

~/BisPin/shell/align_mouse.sh $2.infotrim.fastq $2.infotrim.out $3
